const { white, green, gray, blue } = require('chalk');
...
const solutions = {
    ...
    file:
        ...
        gray(
            ' //Please commit or stash your changes or before you merge / sync'
        ),
    pathspec:
        warning +
    ...
    updateInstruction: 'Run ' + blue('npm i -g sync-fork') + ' to update',
};
